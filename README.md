...
**Architecture baseline locked:** [`ARCHITECTURE_BASELINE_V1.md`](ARCHITECTURE_BASELINE_V1.md) is the official source of truth; every formal document references it. Current state: governance/standards/templates operational; capability model authored (86 capabilities, approval pending); Lacteva Collect chapters 1–3 specified; platform foundation code live in `services/platform-core` (M0 — see [`DEVELOPMENT_ROADMAP.md`](docs/21-milestones/DEVELOPMENT_ROADMAP.md)). Latest audit: [`REPOSITORY_AUDIT.md`](docs/21-milestones/REPOSITORY_AUDIT.md); open review items: [`REPOSITORY_MIGRATION_PLAN.md`](docs/21-milestones/REPOSITORY_MIGRATION_PLAN.md) §2.
