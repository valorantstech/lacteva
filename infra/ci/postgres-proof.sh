...
LACTEVA_TEST_POSTGRES_URL="$(app_url_for "${TESTS_DB}")" \
  ...
  tests/test_logistics_postgres.py \
  tests/test_route_generation_postgres.py \
  tests/test_scheduler_routes_postgres.py \
  tests/test_route_report_postgres.py \
  tests/test_idempotency_rls_postgres.py \
  tests/test_collection_slip_postgres.py \
  tests/test_concurrent_capture_postgres.py \
  tests/test_binding_survives_commit_postgres.py \
