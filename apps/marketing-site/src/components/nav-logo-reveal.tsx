...
import { RichDropArt } from "@/components/logo";
 ...
 * render (and therefore the no-JS page) is the static lockup. The drop is
 * the RICH rendering (LACTEVA-MARKETING-003) — the reveal plays lit, and
 * flipping to flat afterwards would be a visible pop, so the nav mark
 * stays rich at rest too; it is drawn by RichDropArt, the same generated
 * geometry and stops every rich surface carries. The play switch is a
 * data attribute flipped after hydration; the animations themselves live
 * in globals.css behind `[data-reveal="on"]`, so nothing re-renders and
 * the static markup is byte-identical either way.
 */
    ...
    >
      <span className="relative flex size-8 items-center justify-center">
        ...
        <svg viewBox="0 0 64 64" aria-hidden="true" className="size-8">
          ...
          {/* Beat 1 — the drop falls, lit. */}
          <RichDropArt idPrefix="nav" className="nav-reveal-drop" />
        </svg>
      </span>
