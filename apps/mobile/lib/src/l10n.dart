...
const Catalog _en = {
  // WO-72 Part C — the manager's own screen.
  'hub.counter': 'The counter',
  'hub.round': 'The round',
  'mgr.morningCollection': 'Morning collection',
  'mgr.expected': 'of ~{value} {unit} expected',
  'mgr.noExpectation': 'no same-day figure to compare',
  'mgr.up': '▲ {pct}% vs {day}',
  'mgr.down': '▼ {pct}% vs {day}',
  ...
  'mgr.view': 'VIEW',
  'mgr.sync': 'SYNC',
  'mgr.unpricedTitle': '{count, plural, one{# collection waiting for a price} other{# collections waiting for a price}}',
  'mgr.unpricedDetail': 'accepted milk with no published rate for its day',
  'mgr.syncTitle': '{count, plural, one{# capture not yet synced} other{# captures not yet synced}}',
  'mgr.syncDetail': 'saved on this phone; the platform has not seen them',
  'mgr.farmersTitle': '{count, plural, one{# regular farmer has not arrived} other{# regular farmers have not arrived}}',
  'mgr.farmersDetail': 'active at this centre; not yet served today',
  'mgr.last7': 'Last 7 mornings',
  'mgr.avg': 'avg {value}',
  'mgr.noHistory': 'The first week draws the chart.',
  'mgr.sessionOpen': 'Session open',
  'mgr.sessionClosed': 'No open session',
  'day.short.0': 'M',
  'day.short.1': 'T',
  'day.short.2': 'W',
  'day.short.3': 'T',
  ...
  'day.name.5': 'Sat',
  'day.name.6': 'Sun',
  // WO-72 Part B — the bottom bar and the hubs behind it.
  'nav.today': 'Today',
  'nav.collect': 'Collect',
  'nav.farmers': 'Farmers',
  'nav.money': 'Money',
  ...
  'nav.bill': 'Invoices',
  'hub.settlements': 'Settlements',
  'hub.payments': 'Payments',
  'hub.receipts': 'Receipts',
  'hub.rateCards': 'Rate cards',
  'hub.matrices': 'Pricing matrices',
  'hub.rateTest': 'Test a rate',
  'hub.todaySummary': "Today's summary",
  'hub.transactions': 'Collections',
  'hub.notifications': 'Notifications',
  'hub.centres': 'Centres',
  'hub.centreCalendar': 'Centre calendar',
  'hub.readiness': 'Readiness',
  'hub.instruments': 'Instruments',
  'hub.sync': 'Sync',
  'hub.signOut': 'Sign out',
  'hub.noCentre': 'No centre in your scope yet',
  'hub.noBills': 'No invoices yet',
  ...
  'customer.receiptsFor': 'Payments against this invoice',
  'customer.noReceiptsFor': 'No payment has been recorded against this invoice yet.',
  'customer.notices': 'Notices',
  'customer.rateForDay': 'rate agreed for this day',
  'push.why': 'Lacteva can tell you when an invoice is ready or a payment is recorded. Android will ask next.',
  ...
  'wizard.grossKg': 'Gross ({unit})',
  'wizard.tareKg': 'Tare ({unit})',
  ...
  'wizard.netWeightLine': 'Net weight: {qty} {unit}',
  'wizard.paidLine': 'Paid quantity: {qty} {unit} (x {factor} kg/L)',
  ...
  'driver.pours': 'Standing order',
  'driver.quantityTitle': 'How much did you pour?',
  'driver.confirmDelivered': 'Confirm delivered',
  'driver.addItem': '+ Add item',
  'driver.itemTitle': 'Add an item',
  'driver.itemNoPrice': 'No price in the catalogue — the owner must set one.',
  'driver.itemAdded': 'Item added',
  'driver.itemQuantity': 'Quantity',
  'driver.noCatalogue': 'Nothing in the catalogue yet. Ask the office to add the items it sells.',
  'driver.whichProduct': 'Which milk?',
  ...
  'round.customerCount': '{count, plural, =0{nothing left to deliver} one{# left to deliver} other{# left to deliver}}',
...
const Catalog _hi = {
  ...
  'hub.counter': 'काउंटर',
  'hub.round': 'राउंड',
  'mgr.morningCollection': 'सुबह का संग्रह',
  'mgr.expected': 'अपेक्षित ~{value} {unit} में से',
  'mgr.noExpectation': 'तुलना के लिए उसी दिन का आँकड़ा नहीं',
  'mgr.up': '▲ {pct}% बनाम {day}',
  'mgr.down': '▼ {pct}% बनाम {day}',
  'mgr.level': '= {day} जितना',
  ...
  'mgr.view': 'सूची',
  'mgr.sync': 'सिंक',
  'mgr.unpricedTitle': '{count, plural, one{# संग्रह दाम के इंतज़ार में} other{# संग्रह दाम के इंतज़ार में}}',
  'mgr.unpricedDetail': 'स्वीकृत दूध, जिसके दिन का कोई प्रकाशित रेट नहीं',
  'mgr.syncTitle': '{count, plural, one{# प्रविष्टि अभी सिंक नहीं हुई} other{# प्रविष्टियाँ अभी सिंक नहीं हुईं}}',
  'mgr.syncDetail': 'इस फ़ोन में सहेजी; प्लेटफ़ॉर्म तक नहीं पहुँचीं',
  'mgr.farmersTitle': '{count, plural, one{# नियमित किसान नहीं आया} other{# नियमित किसान नहीं आए}}',
  'mgr.farmersDetail': 'इस केंद्र पर सक्रिय; आज अभी तक नहीं आए',
  'mgr.last7': 'पिछली 7 सुबहें',
  'mgr.avg': 'औसत {value}',
  'mgr.noHistory': 'पहला हफ़्ता चार्ट बनाता है।',
  'mgr.sessionOpen': 'सत्र खुला',
  'mgr.sessionClosed': 'कोई खुला सत्र नहीं',
  'day.short.0': 'सो',
  'day.short.1': 'मं',
  'day.short.2': 'बु',
  'day.short.3': 'गु',
  ...
  'nav.bill': 'इनवॉइस',
  'hub.settlements': 'सेटलमेंट',
  'hub.payments': 'भुगतान',
  'hub.receipts': 'रसीदें',
  'hub.rateCards': 'रेट कार्ड',
  'hub.matrices': 'रेट तालिकाएँ',
  'hub.rateTest': 'रेट जाँचें',
  'hub.todaySummary': 'आज का सार',
  'hub.transactions': 'संग्रह सूची',
  'hub.notifications': 'सूचनाएँ',
  'hub.centres': 'केंद्र',
  'hub.centreCalendar': 'केंद्र कैलेंडर',
  'hub.readiness': 'तैयारी',
  'hub.instruments': 'उपकरण',
  'hub.sync': 'सिंक',
  'hub.signOut': 'साइन आउट',
  'hub.noCentre': 'आपके दायरे में अभी कोई केंद्र नहीं',
  'hub.noBills': 'अभी कोई इनवॉइस नहीं',
  ...
  'customer.statementTitle': 'इस महीने का सार',
  'customer.opening': 'पिछला शेष',
  'customer.billedLabel': 'बिल किया गया',
  'customer.closing': 'आपका बकाया',
  'customer.loadMore': 'पुराने बिल दिखाएँ',
  'customer.allLoaded': 'बस, सभी बिल यही हैं।',
  'customer.receiptsFor': 'इस बिल पर हुए भुगतान',
  'customer.noReceiptsFor': 'इस बिल पर अभी कोई भुगतान दर्ज नहीं हुआ।',
  'customer.notices': 'सूचनाएँ',
  'customer.rateForDay': 'इस दिन के लिए तय दर',
  'push.why': 'बिल तैयार होने या भुगतान दर्ज होने पर Lacteva आपको बता सकता है। Android अब पूछेगा।',
  ...
  'wizard.weight': 'वज़न',
  'wizard.grossKg': 'सकल ({unit})',
  'wizard.tareKg': 'खाली ({unit})',
  ...
  'wizard.netWeightLine': 'शुद्ध: {qty} {unit}',
  'wizard.paidLine': 'भुगतान मात्रा: {qty} {unit} (x {factor} kg/L)',
  'wizard.qualityLine': 'FAT {fat} · SNF {snf} · CLR {clr}',
  ...
  'driver.pours': 'नियमित ऑर्डर',
  'driver.quantityTitle': 'कितना दिया?',
  'driver.confirmDelivered': 'दिया गया — पक्का',
  'driver.addItem': '+ सामान जोड़ें',
  'driver.itemTitle': 'सामान जोड़ें',
  'driver.itemNoPrice': 'कैटलॉग में दाम नहीं है — मालिक को तय करना होगा।',
  'driver.itemAdded': 'सामान जुड़ गया',
  'driver.itemQuantity': 'मात्रा',
  'driver.noCatalogue': 'कैटलॉग में अभी कुछ नहीं। दफ़्तर से बिकने वाला सामान जुड़वाएँ।',
  'driver.whichProduct': 'कौन सा दूध?',
  ...
  'round.customerCount': '{count, plural, =0{कुछ नहीं बचा} one{# पहुँचाना बाकी} other{# पहुँचाना बाकी}}',
...
const Catalog _ar = {
  ...
  'hub.counter': 'المنضدة',
  'hub.round': 'الجولة',
  'mgr.morningCollection': 'استلام الصباح',
  'mgr.expected': 'من ~{value} {unit} متوقعة',
  'mgr.noExpectation': 'لا رقم لليوم نفسه للمقارنة',
  'mgr.up': '▲ {pct}% مقابل {day}',
  'mgr.down': '▼ {pct}% مقابل {day}',
  'mgr.level': '= مثل {day}',
  ...
  'mgr.view': 'عرض',
  'mgr.sync': 'مزامنة',
  'mgr.unpricedTitle': '{count, plural, one{عملية استلام واحدة بانتظار السعر} two{عمليتا استلام بانتظار السعر} few{# عمليات استلام بانتظار السعر} other{# عملية استلام بانتظار السعر}}',
  'mgr.unpricedDetail': 'حليب مقبول بلا سعر منشور ليومه',
  'mgr.syncTitle': '{count, plural, one{عملية واحدة لم تُزامَن بعد} two{عمليتان لم تُزامَنا بعد} few{# عمليات لم تُزامَن بعد} other{# عملية لم تُزامَن بعد}}',
  'mgr.syncDetail': 'محفوظة على هذا الهاتف؛ لم تصل المنصة',
  'mgr.farmersTitle': '{count, plural, one{مزارع منتظم واحد لم يصل} two{مزارعان منتظمان لم يصلا} few{# مزارعين منتظمين لم يصلوا} other{# مزارعًا منتظمًا لم يصلوا}}',
  'mgr.farmersDetail': 'نشطون في هذا المركز؛ لم يُخدَموا اليوم بعد',
  'mgr.last7': 'آخر 7 صباحات',
  'mgr.avg': 'المتوسط {value}',
  'mgr.noHistory': 'الأسبوع الأول يرسم المخطط.',
  'mgr.sessionOpen': 'الجلسة مفتوحة',
  'mgr.sessionClosed': 'لا جلسة مفتوحة',
  'day.short.0': 'ن',
  'day.short.1': 'ث',
  'day.short.2': 'ر',
  'day.short.3': 'خ',
  ...
  'nav.bill': 'الفواتير',
  'hub.settlements': 'التسويات',
  'hub.payments': 'المدفوعات',
  'hub.receipts': 'الإيصالات',
  'hub.rateCards': 'بطاقات الأسعار',
  'hub.matrices': 'جداول الأسعار',
  'hub.rateTest': 'اختبار سعر',
  'hub.todaySummary': 'ملخص اليوم',
  'hub.transactions': 'عمليات الاستلام',
  'hub.notifications': 'الإشعارات',
  'hub.centres': 'المراكز',
  'hub.centreCalendar': 'تقويم المركز',
  'hub.readiness': 'الجاهزية',
  'hub.instruments': 'الأجهزة',
  'hub.sync': 'المزامنة',
  'hub.signOut': 'تسجيل الخروج',
  'hub.noCentre': 'لا مركز ضمن نطاقك بعد',
  'hub.noBills': 'لا فواتير بعد',
  ...
  'customer.statementTitle': 'هذا الشهر بلمحة',
  'customer.opening': 'رصيد سابق',
  'customer.billedLabel': 'المفوتر',
  'customer.closing': 'المستحق عليك',
  'customer.loadMore': 'عرض الفواتير الأقدم',
  'customer.allLoaded': 'هذه كل الفواتير.',
  'customer.receiptsFor': 'الدفعات على هذه الفاتورة',
  'customer.noReceiptsFor': 'لم تُسجَّل أي دفعة على هذه الفاتورة بعد.',
  'customer.notices': 'إشعارات',
  'customer.rateForDay': 'سعر متفق عليه لهذا اليوم',
  'push.why': 'يمكن لـ Lacteva إخبارك عند جهوز فاتورة أو تسجيل دفعة. سيسألك أندرويد بعد قليل.',
  ...
  'wizard.weight': 'الوزن',
  'wizard.grossKg': 'الإجمالي ({unit})',
  'wizard.tareKg': 'الفارغ ({unit})',
  ...
  'wizard.netWeightLine': 'الصافي: {qty} {unit}',
  'wizard.paidLine': 'الكمية المدفوعة: {qty} {unit} (x {factor} كغ/لتر)',
  'wizard.qualityLine': 'FAT {fat} · SNF {snf} · CLR {clr}',
  ...
  'wizard.netLine': 'الصافي {qty} {unit}',
  ...
  'driver.pours': 'الطلب الدائم',
  'driver.quantityTitle': 'كم سلّمت؟',
  'driver.confirmDelivered': 'تأكيد التسليم',
  'driver.addItem': '+ إضافة صنف',
  'driver.itemTitle': 'إضافة صنف',
  'driver.itemNoPrice': 'لا سعر في الكتالوج — على المالك تحديده.',
  'driver.itemAdded': 'تمت إضافة الصنف',
  'driver.itemQuantity': 'الكمية',
  'driver.noCatalogue': 'لا شيء في الكتالوج بعد. اطلب من المكتب إضافة الأصناف.',
  'driver.whichProduct': 'أي حليب؟',
  ...
  'round.customerCount': '{count, plural, zero{لم يتبقَّ شيء للتوصيل} one{بقي توصيل واحد} two{بقي توصيلان} few{بقي # توصيلات} other{بقي # توصيلة}}',
