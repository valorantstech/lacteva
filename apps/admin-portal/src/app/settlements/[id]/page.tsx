      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>
              Every figure below was computed and stored by the platform. This
          ...
          <CardContent className="flex flex-col gap-4">
            ...
            {totals_match_lines ? (
              <p className="inline-flex items-center gap-2 text-sm text-muted-foreground">
                ...
                {s.line_count === 1 ? "line" : "lines"} — verified by the
                platform.
              </p>
            ) : (
              <p
              ...
              >
                ...
                Stored totals no longer match the lines. Recalculate before
                finalizing.
              </p>
            )}
          </CardContent>
          ...
          {confirming ? (
            <div className="flex flex-col gap-3 rounded-md border border-destructive/40 bg-destructive/5 p-4">
              <p className="inline-flex items-start gap-2 text-sm font-medium">
                ...
                />
                <span>
                  Finalizing {s.settlement_number} is permanent. Once finalized
                  this settlement cannot be edited, recalculated, or cancelled —
                  a correction has to be a new settlement or an adjustment. Its
                  net payable of{" "}
                  <Money amount={s.net_amount} currency={s.currency} /> becomes
      ...
      {balance ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Allocated counts every live payment, including drafts — an intent
              reserves the money, so a second payment can never be built on it.
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                >
                  <div className="flex flex-col">
                    ...
                    >
                      <ReceiptIcon
                        aria-hidden
                        className="me-1.5 inline size-3.5"
                      />
                      {r.receipt_number}
                    </Link>
                    <span className="text-xs text-muted-foreground">
                  ...
                  {lines.map((line: SettlementLine) => (
                    <tr key={line.id} className="border-b last:border-0">
                      <td className="py-2 pe-4 tabular-nums">
                        {String(line.transaction_date).slice(0, 10)}
                      </td>
