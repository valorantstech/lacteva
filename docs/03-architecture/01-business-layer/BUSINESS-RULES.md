...
**Status:** Active (since SEC-001; the platform-global clause added by CI-001; extended by SEC-002 to complete coverage, isolate `organization` by identity, and fix the binding order — the guarantee previously held for 37 of 56 tables).
