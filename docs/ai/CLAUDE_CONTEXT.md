...
Current test posture: **514 backend tests, 26 Flutter widget tests**, portal build+lint, docs validator + XREF — all green, enforced by CI, verified before every commit.
